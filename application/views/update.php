	...
	<form action="http://localhost/codeigniter/formislem/submit" id="registrationForm" class="form border-0 needs-validation " method="post" novalidate>
		<div class="needs-validation">
			<div class="UyeBilgisi border-top border-2">
				...
				<div class="row d-flex justify-content-between">
					<div class="col-md-6" style="position: relative;">
						...
						<span class="p-2" style="width: 100%; display: block; padding-left: 60px;">
                                <input type="text" id="firstName" name="firstName" required placeholder="İsim" style="width: 100%; padding-left: 40px; border-radius: 5px;" value="<?php echo $row->firstName; ?>">
                            </span>
					</div>
					<div class="col-md-6" style="position: relative;">
						<i class="bi bi-person" style="position:absolute; left: 20px; top: 7px; background-color: aqua; padding: 3px 8px;"></i>
						<span class="p-2" style="width: 100%; display: block; padding-left: 60px;">
                                <input type="text" id="lastName" name="lastName" required placeholder="Soyisim" style="width: 100%; padding-left: 40px; border-radius: 5px;" value="<?php echo $row->lastName; ?>" >
                            </span>
					</div>
				</div>
				<div class="row d-flex justify-content-between">
					<div class="col-md-6" style="position: relative;">
                            <span class="p-2">
                                ...
                                <input type="password" id="password" name="password" placeholder="Şifre" required value="<?php echo $row->password; ?>">
				...
				<div class="row d-flex justify-content-between">
					<div class="col-md-6" style="position: relative;">
						...
						<span class="p-2" style="width: 100%; display: block; padding-left: 60px;">
                                <input type="email" id="email" name="email" placeholder="Mail" style="width: 100%; padding-left: 40px; border-radius: 5px;" required value="<?php echo $row->email; ?>">
                            </span>
					</div>
					<div class="col-md-6" style="position: relative;">
						<i class="bi bi-telephone"></i>
						<span class="p-2">
                                <input type="tel" id="phone" name="phone" placeholder="Telefon" required value="<?php echo $row->phone; ?>">
                            </span>
					</div>
				</div>
			</div>
			<div class="PersonelBilgisi border-top border-2 my-2">
				...
				<div class="row d-flex">
					...
					<div class="col-md-6" style="position: relative;">
						<i class="bi bi-person" style="position: absolute; left: 20px; top: 7px; background-color: aqua; padding: 3px 8px;"></i>
						<span class="p-2" style="width: 100%; display: block; padding-left: 60px;">
                                <input type="text" id="age" name="age" placeholder="Yaş" required value="<?php echo $row->age; ?>">
                            </span>
					</div>
				</div>
				<div class="row d-flex justify-content-between">
					...
					<div class="col-md-6" style="position: relative;">
						...
						<span class="p-2" style="width: 100%; display: block; padding-left: 60px;">
                                <input type="text" class="form-control" id="birthdate" name="birthDate" style="width: 100%; padding-left: 40px; border-radius: 5px;" required placeholder="gg.aa.yyyy" value="<?php echo $row->birthDate; ?>">
                            </span>
					</div>
					<div class="col-md-6" style="position: relative;">
						<i class="bi bi-person-vcard-fill" style="position: absolute; left: 20px; top: 7px; background-color: aqua; padding: 3px 8px;"></i>
						<span class="p-2" style="width: 100%; display: block; padding-left: 60px;">
                                <input type="text" id="tc" name="tc" placeholder="TC Kimlik" required value="<?php echo $row->tc; ?>">
                            </span>
					</div>
				</div>
				<div class="mb-3 justify-content-between" style="height: 100px;">
					...
					<textarea class="form-control overflow-auto" id="address" name="address" placeholder="Adresinizi giriniz" value="<?php echo $row->address; ?>"></textarea>
				</div>
			</div>
			<div class="ek border-top border-2">
				...
				<textarea class="form-control" id="additional" name="additional" value="<?php echo $row->additional; ?>"></textarea>
				<div class="row d-flex justify-content-between align-items-center">
					<!-- Dosya Seçme -->
					<div class="col-md-6" style="position: relative;">
						<label for="file" class="form-label" style="margin-left: -60px;">Dosya Seç</label>
						<input type="file" class="form-control-file" id="file" name="file" style="margin-left: -40px;" value="<?php echo $row->file; ?>">
